                ...
                <div>
                    ...
                    <div className='mt-[15px] mb-[20px]'>
                        <label className='cursor-pointer flex items-center gap-[5px] text-[14px] ' htmlFor="custom-checkbox">
                            <CustomCheckbox />
                            I agree with
                            <a className="text-[#0d6efd] flex items-center gap-[5px] inline pointer-events-none" href="">Privacy Policy <img src="/meta/reject.svg" className="w-[10px] h-[10px] items-center inline" alt="" /></a>
                        </label>
                    </div>
